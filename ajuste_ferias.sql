...
/*Retorna os demais campos do registro de solicitação de férias mais atual do colaborador e converte os tipos de data para
o formato DATE yyyy-mm-dd.*/
,ferias AS
(
    SELECT 
        tabela.campanha
...
WHERE CONCAT(int_participantes_dia_util.matricula,'-',
            int_participantes_dia_util.num_dnd,'-',
            int_participantes_dia_util.data_movimento)
IN
(
    SELECT dias_uteis.chave FROM dias_uteis
